    ...
    methods: {
        ...
        cypherrun() {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: this.contextRoot + "getcypherresult",
        ...
        initEditor() {
            ...
            _this.editor.customConfig.uploadImgServer = this.contextRoot + "qiniu/upload"; // 上传图片到服务器
        ...
        initNodeContent() {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: this.contextRoot + "getnodecontent",
                success: function (result) {
        ...
        initNodeImage() {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: this.contextRoot + "getnodeimage",
                success: function (result) {
                    if (result.code == 200) {
        ...
        getNodeDetail(nodeid) {
            ...
            //     data: data,
            //     type: "POST",
            //     url: this.contextRoot + "getnodedetail",
            //     success: function (result) {
            //         if (result.code == 200) {
            //             _this.editorcontent = result.data.content;
        ...
        deletelink() {
            ...
            this.$confirm('此操作将删除该关系(不可恢复), 是否继续?', '三思而后行', {
                ...
                $.ajax({
                    data: data,
                    type: "POST",
                    url: this.contextRoot + "deletelink",
                    success: function (result) {
                        if (result.code == 200) {
                            var j = -1;
                            for (var i = 0; i < _this.graph.links.length; i++) {
        ...
        createlink(sourceId, targetId, ship) {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: this.contextRoot + "createlink",
                success: function (result) {
                    if (result.code == 200) {
        ...
        updatelinkName() {
            ...
            _this.$prompt('请输入关系名称', '提示', {
                ...
                $.ajax({
                    data: data,
                    type: "POST",
                    url: this.contextRoot + "updatelink",
                    success: function (result) {
                        if (result.code == 200) {
                            var newship = result.data;
