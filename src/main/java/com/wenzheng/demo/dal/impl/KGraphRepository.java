//package com.wenzheng.demo.dal.impl;
//
...
//import com.wenzheng.demo.util.GraphPageRecord;
//import com.wenzheng.demo.util.Neo4jUtil;
//import com.wenzheng.demo.util.StringUtil;
...
//
//                // 下边的查询查不到单个没有关系的节点,考虑要不要左箭头
//                String nodeSql = String.format("match data=(n:`mode`{name:'挂号'})-[*1..3]->(e) where e.name='%s' return data limit %s",query.getNodename(), query.getPageSize());
//                HashMap<String, Object> graphNode = neo4jUtil.GetGraphNodeAndShip(nodeSql);
//                Object node = graphNode.get("node");
//                // 没有关系显示则显示节点
//                if (node != null) {
