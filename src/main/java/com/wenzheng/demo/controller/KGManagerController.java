...
//    private IKnowledgegraphService kgservice;
    ...
    public R<HashMap<String, Object>> getDomainGraph(GraphQuery query) {
        ...
        try {
            HashMap<String, Object> graphData = modeService.getall();
            result.code = 200;
...
//
    ...
    public R<HashMap<String, Object>> getDomainGraphMode(GraphQuery query) {
        ...
        try {
            ...
            HashMap<String, Object> graphData = modeService.getModeGraph(query.getNodename());
            result.code = 200;
            result.data = graphData;
...
//
    ...
    public R<String> updateCorrdOfNode(String domain, long uuid, Double fx, Double fy) {
        R<String> result = new R<String>();
        try {
            mode mode = modeService.findbyid(uuid);
            mode.setFx(fx);
            mode.setFy(fy);
...
//
    ...
    public R<HashMap<String, Object>> createnode(QAEntityItem entity, HttpServletRequest request,
        ...
        try {
            graphNode = modeService.createnode(entity);
...
//
    ...
    public R<HashMap<String, Object>> batchcreatechildnode(String domain, long sourceid, Integer entitytype,
                                                           String[] targetnames, String relation) {
        R<HashMap<String, Object>> result = new R<HashMap<String, Object>>();
        HashMap<String, Object> rss = new HashMap<String, Object>();
        try {
            rss = modeService.batchcreatechildnode(sourceid, targetnames);
            result.code = 200;
            result.setData(rss);
            return result;
...
//
    ...
    public R<List<HashMap<String, Object>>> deletenode(String domain, long nodeid) {
        R<List<HashMap<String, Object>>> result = new R<List<HashMap<String, Object>>>();
        try {
            List<HashMap<String, Object>> rList = modeService.deletenode(nodeid);
            result.code = 200;
